...
Cell representation & Conventional cubic, 424 framework atoms \\
Unit cells & 1 x 1 x 1 of the conventional cell \\
LAMMPS units & real \\
...
For the Tao-like IRMOF-1 setup, the primitive 106-atom CRAFTED CIF is transformed into the conventional cubic 424-atom simulation cell.
The transformation preserves the explicit CIF charges and is followed by the configured cell repetitions.
