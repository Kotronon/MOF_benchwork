...
\subsection{Planned Statistical Extensions}

The next scientific development step is statistical validation.
The most important additions are:

\begin{itemize}
    \item convergence analysis by plotting loading as a function of simulation step or block index,
    \item multiple independent runs using different random seeds,
